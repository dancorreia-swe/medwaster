...
<!--
  ...
  for this feature. Expand the chosen workspace structure with real paths
  and specific feature modules. The delivered plan must specify which
  workspace(s) will be modified.
-->
```
