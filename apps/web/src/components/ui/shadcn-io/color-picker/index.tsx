...
export const ColorPickerSelection = memo(
  ({ className, ...props }: ColorPickerSelectionProps) => {
    ...
    // Initialize position based on saturation and lightness
    useEffect(() => {
      if (!isDragging) {
...
export const ColorPickerPreview = ({
  ...
  return (
    ...
    >
      ...
      <div
        className="relative flex h-10 w-full items-center justify-center overflow-hidden rounded-md border border-input shadow-sm transition-all"
