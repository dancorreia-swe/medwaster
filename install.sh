...
echo -e "\n${BLUE}Optional - Enable self-hosted AI:${NC}"
echo -e "Lightweight (recommended): ${GREEN}docker compose --profile ollama --profile whisper up -d ollama whisper${NC}"
echo -e "Heavy (LocalAI): ${GREEN}docker compose --profile localai up -d localai${NC}"
